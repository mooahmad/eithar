...
Route::get('x',function (){
   // $a = unserialize("a:3:{i:0;s:1:\"0\";i:1;s:1:\"2\";i:2;s:1:\"4\";}");
    $a= unserialize('s:12:"[2, 3, 1, 4]";');
    if (is_string($a)) {
        $a = str_replace(['[',']'], '', $a);
        $a = str_replace([', '], ',', $a);
        $a = explode(',', $a);
...
Route::group(['namespace' => AD], function () {
       Route::get('/sms/{mobile}', 'SmsController@forgetPassword');
...
Route::group(['namespace' => PRON, 'prefix' => AD], function () {
    ...
    Route::get('getsuspended_providers', 'ProvidersController@getSuspendedProviders')->name('getSuspendedProviders');
    Route::get('getsuspended_providersdatatable', 'ProvidersController@getSuspenedProvidersDataTable')->name('getSuspendedProvidersDatatable');
    ...
    Route::get('provider/{id}/getMeetings', 'ProvidersController@getMeetings')->name('getProviderMeetings');
    Route::get('get-provider-meetings-Datatable', 'ProvidersController@getBookingProvidersDataTable')->name('getBookingProvidersDataTable');
...
Route::group(['middleware' => 'AdminAuth', 'prefix' => AD], function () {
    Route::group(['namespace' => CUSN], function () {
        ...
        Route::get('suspended-customers', 'CustomersController@getSuspendedCustomers')->name('getSuspendedCustomers');

        Route::get('get-customers-Datatable', 'CustomersController@getCustomersDataTable')->name('get-customers-Datatable');
        Route::get('get-suspended-customers-Datatable', 'CustomersController@getSuspendedCustomersDataTable')->name('get-suspened-customers-Datatable');
...
Route::group(['prefix' => AD], function () {
    ...
    Route::group(['namespace' => BSN], function () {
        ...
        Route::post('meetings/cancel', 'BookingServicesController@cancelMeeting')->name('cancel-meeting');
    });
