...
function Worker() {
    ...
    // Connect ClusterWS http handler and express module
    httpServer.on('request', express)

    // Socket part (listen on connection to the socket)
    var trackProvider = socketServer.on('connection', function (clientSocket, request) {
