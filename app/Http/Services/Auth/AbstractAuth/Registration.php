...
class Registration implements IRegistration
{
    ...
    public function registerCustomer(Request $request)
    {
	    ...
	    $customerData->city_name = ($customer->city) ? $customer->city->{'city_name_'.$lang} : "";
	    $customerData->country_name = ($customer->country) ? $customer->country->country_name_eng : "";
        if (!Auth::check())
