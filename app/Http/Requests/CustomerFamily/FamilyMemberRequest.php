...
class FamilyMemberRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'mobile_number'         => ['required',Rule::unique('family_members')->ignore($this->family_member,'id')],
            'national_id'           => ['required',Rule::unique('family_members')->ignore($this->family_member,'id')],
