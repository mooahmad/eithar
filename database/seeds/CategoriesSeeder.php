...
class CategoriesSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('categories')->insert([
                                            ...
                                            'profile_picture_path' => url('public/images/Doctor.pdf'),
                                            'created_at'       => \Carbon\Carbon::now()->toDateTimeString(),
                                        ]);
        DB::table('categories')->insert([
                                            'category_name_ar' => 'معمل',
                                            'category_name_en' => 'Lap',
                                            'profile_picture_path' => url('public/images/Lab.pdf'),
                                            'created_at'       => \Carbon\Carbon::now()->toDateTimeString(),
                                        ]);
        DB::table('categories')->insert([
                                            'category_name_ar' => 'علاج طبيعى',
                                            'category_name_en' => 'Physiotherapy',
                                            'profile_picture_path' => url('public/images/Physiotherapy.pdf'),
                                            'created_at'       => \Carbon\Carbon::now()->toDateTimeString(),
                                        ]);
        DB::table('categories')->insert([
                                            'category_name_ar' => 'تمريض',
                                            'category_name_en' => 'Nursing',
                                            'profile_picture_path' => url('public/images/Nursing.pdf'),
                                            'created_at'       => \Carbon\Carbon::now()->toDateTimeString(),
                                        ]);
        DB::table('categories')->insert([
                                            'category_name_ar' => 'أمومه و طفوله',
                                            'category_name_en' => 'WomanAndChild',
                                            'profile_picture_path' => url('public/images/Women.pdf'),
                                            'created_at'       => \Carbon\Carbon::now()->toDateTimeString(),
                                        ]);
    }
}
