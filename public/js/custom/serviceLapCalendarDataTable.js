...
function datatable() {
    ...
    mainTable = $('#data-table-calendar').DataTable({
        ...
        columns: [
            {data: 'id', name: 'lap_calendars.id'},
            {data: 'start_date', name: 'lap_calendars.start_date'},
            {data: 'end_date', name: 'lap_calendars.end_date'},
            {data: 'is_available', name: 'lap_calendars.is_available'},
            {
                searchable: false,
                orderable: false,
                data: 'actions',
