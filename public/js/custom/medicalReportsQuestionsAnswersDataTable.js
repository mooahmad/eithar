...
function datatable() {
    ...
    mainTable = $('#data-table-medical_reports').DataTable({
        ...
        columns: [
            {data: 'id', name: 'booking_medical_reports_answers.id'},
            {data: 'title_ar', name: 'booking_medical_reports_answers.title_ar'},
            {data: 'title_en', name: 'booking_medical_reports_answers.title_en'},
            {
                searchable: false,
                orderable: false,
                data: 'actions',
