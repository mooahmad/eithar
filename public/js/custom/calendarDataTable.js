...
function datatable() {
    ...
    mainTable = $('#data-table-calendar').DataTable({
        ...
        columns: [
            ...
            {data: 'start_date', name: 'providers_calendars.start_date'},
            {data: 'end_date', name: 'providers_calendars.end_date'},
            {data: 'is_available', name: 'providers_calendars.is_available'},
            {
                searchable: false,
                orderable: false,
                data: 'actions',
