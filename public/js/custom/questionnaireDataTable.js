...
function datatable() {
    $('#data-table-questionnaire').dataTable().fnDestroy();
    $.fn.dataTable.ext.errMode = 'throw';
    mainTable = $('#data-table-questionnaire').DataTable({
        "bfilter": false,
        "dom": 'B f l t p r i',
        "paging": true,
        "searching": true,
        ...
        },
            {
                ...
                action: function () {
                    ...
                    $('#btn-modal-delete').on('click', function () {
                        deleteQuestionnaireRecords(ids)
                    });
        ...
        columns: [
            ...
            {data: 'title_ar', name: 'questionnaires.title_ar'},
            {data: 'title_en', name: 'questionnaires.title_en'},
            {
                searchable: false,
                orderable: false,
                data: 'actions',
...
function deleteQuestionnaireRecords(ids) {
    $.ajax({
        url: deleteQuestionnaireURL,
        type: "Post",
        data: {
            "_token": csrfToken,
            ids: ids
