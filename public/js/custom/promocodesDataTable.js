...
function datatable() {
    $('#data-table-promo-codes').dataTable().fnDestroy();
    $.fn.dataTable.ext.errMode = 'throw';
    mainTable = $('#data-table-promo-codes').DataTable({
        "bfilter": false,
        "dom": 'B f l t p r i',
        "paging": true,
        "searching": true,
...
function deletePromoCodesRecords(ids) {
    $.ajax({
        url: deletePromoCodesURL,
        type: "Post",
        data: {
            "_token": csrfToken,
            ids: ids
