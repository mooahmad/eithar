...
<div class="content">
    ...
    <div class="form-group">
        {!! Form::email('email', old('email'), array('id'=>'email', 'class'=>'form-control','placeholder'=>trans('admin.email'))) !!}
    </div>
    <div class="form-group">
        {!! Form::text('code', "" , array('id'=>'code', 'class'=>'form-control','placeholder'=>trans('admin.code'))) !!}
    </div>
    <div class="form-group">
