                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tr>
                                <th>
                                    ...
                                    <button type="button" class="btn btn-danger delete_all_selected" data-toggle="modal"
                                            data-target="#myModalSelected" id="delete_all_selected" disabled="disabled">
                                        Delete All Selected
                                    </button>
                                </th>
                            </tr>
                            ...
                            @foreach($all as $admin)
                                <tr id="user_{{ $admin->id }}" @if($admin->status == 0)class="danger" @endif>
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                            <input type="checkbox" name="perm[]" class="All_Checkbox checkboxes"
                                                   value="{{ $admin->id }}"/>
                                            <span></span>{{ $admin->id }}
                                        </label>
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{url('Administrator/admins/'.$admin->id.'/edit')}}"
