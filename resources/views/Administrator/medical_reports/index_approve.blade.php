...
@section('script')
    ...
    <script>
        var medicalReportsDataTableURL = "{!! route('getApproveMedicalReportsDataTable') !!}";
        var deletemedicalReportsURL    = "{!! route('deleteMedicalReportsApprove') !!}";
        var csrfToken          = "{!! csrf_token() !!}";
    </script>
    <script src="{{ asset('public/js/custom/medicalReportsApproveDataTable.js') }}" type="text/javascript"></script>
@stop