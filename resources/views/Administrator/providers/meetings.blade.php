                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <select name="filter" id="filter"  class="form-control" required>
                                    <option value="meeting">All Meetings</option>
                                    <option value="upcoming">Upcoming Meetings</option>
                                    <option value="old">Old Meeting</option>
                                </select>
                            </div>
                        </div>
...
@section('script')
    <script>
        var indexURL = "{!! route('getBookingProvidersDataTable') !!}";
        var deleteURL    = "{!! route('deleteServices') !!}";
        var csrfToken          = "{!! csrf_token() !!}";
        var providerId = "{{$provider->id}}";
    </script>
    <script src="{{ asset('public/js/custom/providerMeetings.js') }}"></script>
