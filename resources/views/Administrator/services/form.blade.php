                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="new_user">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('price', (isset($service))? $service->price : old('price') , array('id'=>'price', 'class'=>'form-control','required'=>'required','placeholder'=>trans('admin.price'))) !!}
                                            @if($errors->has('price'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('visit_duration', (isset($service))? $service->visit_duration : old('visit_duration') , array('id'=>'visit_duration', 'class'=>'form-control','required'=>'required','placeholder'=>trans('admin.visit_duration'))) !!}
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="control-label">
                                                {{ trans('admin.time_before_next_visit') }} <span class="required"> * </span>
                                            </label>
                                            {!! Form::text('time_before_next_visit', (isset($service))? $service->time_before_next_visit : old('time_before_next_visit') , array('id'=>'time_before_next_visit', 'class'=>'form-control','required'=>'required','placeholder'=>trans('admin.time_before_next_visit'))) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('expire_date', (isset($service))? \Carbon\Carbon::parse($service->expiry_date)->format('m/d/Y') : old('expire_date'), array('id'=>'expire_date', 'class'=>'form-control form-control-inline input-medium date-picker','required'=>'required', 'size' => 16, 'type' => 'text')) !!}
