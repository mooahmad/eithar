                            ...
                            <div class="portlet-body">
                                <div class="tab-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('expiry_date', (isset($service))? $service->expiry_date : old('expiry_date'), array('id'=>'expire_date', 'class'=>'form-control form-control-inline input-medium date_time_picker','required'=>'required', 'size' => 16, 'type' => 'text')) !!}
