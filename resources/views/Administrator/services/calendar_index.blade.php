        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="btn-group">
                        <a href="{{ url(AD.'/services/'.$serviceID.'/calendar/create') }}" class="btn sbold green">
                            Add New <i
...
@section('script')
    <script>
        var calendarDataTableURL = "{!! route('getServiceCalendarDatatable', ['id' => $serviceID]) !!}";
        var deleteCalendarURL = "{!! route('deleteServiceCalendar') !!}";
        var csrfToken = "{!! csrf_token() !!}";
    </script>
    <script src="{{ asset('public/js/custom/serviceCalendarDataTable.js') }}" type="text/javascript"></script>
@stop