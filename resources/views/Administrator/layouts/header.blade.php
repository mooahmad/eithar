...
<head>
    ...
    <meta content="Preview page of HUD Systems Admin Theme #1 for statistics, charts, recent events and reports" name="description" />
    ...
    {{--lightbox--}}
    <link href="{{ asset('assets/global/css/lightbox.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link rel="shortcut icon" href="{{ asset('assets/layouts/layout/img/logo_icon.ico') }}" /> </head>
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        <a target="_blank" href="{{ url('/') }}">
                            <img height="30" width="80" src="{{ asset('assets/layouts/layout/img/logo.png') }}" alt="{{ config('app.name') }}" class="logo-default" /> </a>
