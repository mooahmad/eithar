    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
            ...
            @can('provider.view', new \App\Models\Provider())
                ...
                <li class="nav-item start {{ ((Request::segment(2)=='providers') || (Request::is(AD.'/getsuspended_providers'))) ? 'active' :'' }}">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="fa fa-user-secret"></i>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item start {{ (Request::is(AD.'/getsuspended_providers')) ? 'active' :'' }}">
                            <a href="{{route('getSuspendedProviders')}}" class="nav-link ">
                                <i class="fa fa-eye"></i>
                                <span class="title">{{ trans('admin.show_suspended_providers') }}</span>
                            </a>
                        </li>
            ...
            @can('customers.view')
            <li class="nav-item start {{ ((Request::segment(2)=='customers') || ((Request::is(AD.'/suspended-customers')))) ? 'active' :'' }}">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item start {{ (Request::is(AD.'/suspended-customers')) ? 'active' :'' }}">
                    <a href="{{route('getSuspendedCustomers')}}" class="nav-link ">
                            <i class="fa fa-eye"></i>
                            <span class="title">{{ trans('admin.show_suspended_customers') }}</span>
                        </a>
                    </li>
...
{{--                        </li>--}}
                        <li class="nav-item start {{ (Request::is(AD.'/meetings/inprogress')) ? 'active' :'' }}">
                            <a href="{{ url(AD.'/meetings/inprogress') }}" class="nav-link ">
                                <i class="fa fa-eye"></i>
                                <span class="title">{{ __('Bookings') }}</span>
                            </a>
                        </li>
