                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-8 profile-info">
                                    ...
                                    @if($customer->position)
                                        <p>
                                            <a target="_blank" href="https://www.google.com/maps/place/{{ $customer->position }}:;"><i class="fa fa-map-marker"></i> Show Google Map</a>
                                        </p>
                                    @endif
                            ...
                            <div class="tabbable-line tabbable-custom-profile">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li>
                                        <a href="#tab_feeds" data-toggle="tab"> Feeds </a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_appointments">
                                        <div class="portlet-body">
...
@section('script')
    ...
    <script>
        var indexURL  = "{!! url(AD.'/get-customer-appointments-Datatable/'.$customer->id)!!}";
